let t,e,a,o,i,s,n,l;function c(t,e,a,o){Object.defineProperty(t,e,{get:a,set:o,enumerable:!0,configurable:!0})}var r,d="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},u={},g={},h=d.parcelRequireb734;null==h&&((h=function(t){if(t in u)return u[t].exports;if(t in g){var e=g[t];delete g[t];var a={id:t,exports:{}};return u[t]=a,e.call(a.exports,a,a.exports),a.exports}var o=Error("Cannot find module '"+t+"'");throw o.code="MODULE_NOT_FOUND",o}).register=function(t,e){g[t]=e},d.parcelRequireb734=h);var _=h.register;_("gdWc9",function(t,e){let a,o;c(t.exports,"inicalization",function(){return l}),c(t.exports,"closeModal",function(){return d});let i=document.querySelector(".phone-bacdrop"),s=document.querySelector(".phoneLogin-bacdrop"),n=document.querySelector(".phoneLogin__account-name"),l=function(){a=document.querySelector(".header__menu-button"),o=document.querySelector(".phone__close-button"),(null!==a||null!==o)&&(a.addEventListener("click",r),o.addEventListener("click",d))};function r(){"no login"===JSON.parse(localStorage.getItem("status"))?i.classList.remove("is-hidden"):"login"===JSON.parse(localStorage.getItem("status"))&&(s.classList.remove("is-hidden"),n.textContent=JSON.parse(localStorage.getItem("account")).name),a.style.display="none",o.style.display="flex"}function d(){"no login"===JSON.parse(localStorage.getItem("status"))?i.classList.add("is-hidden"):"login"===JSON.parse(localStorage.getItem("status"))&&s.classList.add("is-hidden"),a.style.display="flex",o.style.display="none"}}),_("fXlgs",function(t,e){let a=document.querySelectorAll(".support__item"),o=document.querySelector(".support__scroll-button");o.addEventListener("click",function(){let t=0;a.forEach(e=>{t<=2?e.classList.toggle("no-showe"):t>5&&e.classList.toggle("no-showe"),t+=1}),a[0].classList.contains("no-showe")?o.style.transform="translate(-50%, 0%) rotate(0deg)":o.style.transform="translate(-50%, 0%) rotate(180deg)"})}),_("3QkRd",function(t,e){let a=document.querySelector(".header__exit-button"),o=document.querySelector(".phoneLogin__exit-button"),i=document.querySelector(".header__account-button");if("login"===JSON.parse(localStorage.getItem("status")))i.addEventListener("click",function(){a.classList.contains("is-hidden")?a.classList.remove("is-hidden"):a.classList.contains("is-hidden")||a.classList.add("is-hidden")}),"login"===JSON.parse(localStorage.getItem("status"))&&(a.addEventListener("click",s),o.addEventListener("click",s));function s(){localStorage.clear(),location.reload()}});const b=async()=>{try{return await fetch("https://books-backend.p.goit.global/books/category-list").then(t=>t.json())}catch(t){return t}},m=document.querySelector(".category__list"),p=document.querySelector(".magazine");function k(t,e=!1){let a="";!1===e?a=t.map(t=>`
        ...
        <li class="magazine__item">
        ...
        </li>`).join("")),p.innerHTML=a}const C=async t=>{try{return await fetch(`${t}`).then(t=>t.json())}catch(t){return t}};var y=h("gdWc9");const f=document.querySelector(".header"),v=document.querySelector(".phone__open-button");"login"===JSON.parse(localStorage.getItem("status"))?(r=JSON.parse(localStorage.getItem("account")),f.innerHTML=`<div class="container">
            ...
            <div class="header__account-div">
                ...
                <span class="header__account-name">${r.name}</span>
        ...
        </div>`):localStorage.setItem("status",JSON.stringify("no login")),b().then(t=>{let e;e="",e=t.map(t=>`
        <li class="category__item">
            <span class="category__span">${t.list_name}</span>
        </li>`).join(""),m.insertAdjacentHTML("beforeend",e)}),C("https://books-backend.p.goit.global/books/top-books").then(t=>{k(t,!0)}),v.addEventListener("click",()=>{(0,y.closeModal)()}),(0,y.inicalization)();const $=document.querySelector(".category__list"),L=document.querySelector(".shop_title");document.querySelector(".magazine__book-list"),$.addEventListener("click",function(t){let e=t.target;if(!e.classList.contains("active")){if(!1!==e.parentNode.classList.contains("category__item"))if("All categories"===e.textContent)document.querySelector(".active").classList.remove("active"),e.classList.add("active"),L.innerHTML="Best Sellers <span class='shop_title-purpure'>magazine</span>",C("https://books-backend.p.goit.global/books/top-books").then(t=>{k(t,!0)});else{document.querySelector(".active").classList.remove("active"),e.classList.add("active");let t=e.textContent.split(" ");L.innerHTML=`${t.slice(0,-1).join(" ")} <span class="shop_title-purpure">${t.at(-1)}</span>`,C(`https://books-backend.p.goit.global/books/category?category=${e.textContent}`).then(t=>{k(t)})}}}),h("fXlgs"),h("3QkRd");const w=document.querySelector(".magazine"),S=document.querySelector(".shop_title");w.addEventListener("click",function(t){let e=t.target;if(e.classList.contains("magazine__button")){C(`https://books-backend.p.goit.global/books/category?category=${e.getAttribute("data-type")}`).then(t=>{k(t)});let t=e.getAttribute("data-type").split(" ");S.innerHTML=`${t.slice(0,-1).join(" ")} <span class="shop_title-purpure">${t.at(-1)}</span>`}});const H=async function(t,e){try{let a={method:"PUT",body:JSON.stringify(t),headers:{"Content-Type":"application/json; charset=UTF-8"}};return await fetch(`https://67a8ab426e9548e44fc1adc4.mockapi.io/projects/accounts/${e}`,a).then(t=>t.json())}catch(t){return t}};h("gdWc9");const M=document.querySelector(".magazine"),z=document.querySelector(".addModal-backdrop"),x=document.querySelector(".addModal__close-button"),V=document.querySelector(".addModal__button"),q=document.querySelector(".addModal__img"),E=document.querySelector(".addModal__title"),Z=document.querySelector(".addModal__text"),N=document.querySelector(".addModal__name");M.addEventListener("click",function(c){let r=c.target.parentNode;r.classList.contains("magazine__item")&&""!==r.id&&(q.src=r.getAttribute("data-img"),E.textContent=r.getAttribute("data-title"),Z.textContent=r.getAttribute("data-description"),N.textContent=r.getAttribute("data-author"),t=r.getAttribute("data-img"),e=r.getAttribute("data-title"),a=r.getAttribute("data-description"),o=r.getAttribute("data-author"),i=r.id,l=r.getAttribute("data-type"),s=r.getAttribute("data-amazon"),n=r.getAttribute("data-aplle"),z.classList.remove("is-hidden"))}),x.addEventListener("click",function(){z.classList.add("is-hidden")}),V.addEventListener("click",function(){let c={id:i,imgUrl:t,title:e,text:a,type:l,authorName:o,amazonBuyLink:s,aplleBookBuyLink:n},r=JSON.parse(localStorage.getItem("account"));r.cards.push(c),localStorage.setItem("account",JSON.stringify(r)),H(JSON.parse(localStorage.getItem("account")),JSON.parse(localStorage.getItem("account")).id),z.classList.add("is-hidden")});
//# sourceMappingURL=book-shop.df4ef4f9.js.map
