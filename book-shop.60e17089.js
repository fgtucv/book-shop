let t,e,o,a,n,i,s,l;function c(t,e,o,a){Object.defineProperty(t,e,{get:o,set:a,enumerable:!0,configurable:!0})}var r="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},d={},u={},_=r.parcelRequireb734;null==_&&((_=function(t){if(t in d)return d[t].exports;if(t in u){var e=u[t];delete u[t];var o={id:t,exports:{}};return d[t]=o,e.call(o.exports,o,o.exports),o.exports}var a=Error("Cannot find module '"+t+"'");throw a.code="MODULE_NOT_FOUND",a}).register=function(t,e){u[t]=e},r.parcelRequireb734=_);var m=_.register;m("gdWc9",function(t,e){let o,a;c(t.exports,"inicalization",function(){return l}),c(t.exports,"closeModal",function(){return d});let n=document.querySelector(".phone-bacdrop"),i=document.querySelector(".phoneLogin-bacdrop"),s=document.querySelector(".phoneLogin__account-name"),l=function(){o=document.querySelector(".header__menu-button"),a=document.querySelector(".phone__close-button"),(null!==o||null!==a)&&(o.addEventListener("click",r),a.addEventListener("click",d))};function r(){"no login"===JSON.parse(localStorage.getItem("status"))?n.classList.remove("is-hidden"):"login"===JSON.parse(localStorage.getItem("status"))&&(i.classList.remove("is-hidden"),s.textContent=JSON.parse(localStorage.getItem("account")).name),o.style.display="none",a.style.display="flex"}function d(){"no login"===JSON.parse(localStorage.getItem("status"))?n.classList.add("is-hidden"):"login"===JSON.parse(localStorage.getItem("status"))&&i.classList.add("is-hidden"),o.style.display="flex",a.style.display="none"}}),m("fXlgs",function(t,e){let o=document.querySelectorAll(".support__item"),a=document.querySelector(".support__scroll-button"),n=document.querySelector(".support__scroll-icon");a.addEventListener("click",function(){let t=0;o.forEach(e=>{t<=2?e.classList.toggle("no-showe"):t>5&&e.classList.toggle("no-showe"),t+=1}),o[0].classList.contains("no-showe")?n.style.transform="rotate(180deg)":n.style.transform="rotate(0deg)"})}),m("3QkRd",function(t,e){let o=document.querySelector(".header__exit-button"),a=document.querySelector(".phoneLogin__exit-button"),n=document.querySelector(".header__account-button");if("login"===JSON.parse(localStorage.getItem("status")))n.addEventListener("click",function(){o.classList.contains("is-hidden")?o.classList.remove("is-hidden"):o.classList.contains("is-hidden")||o.classList.add("is-hidden")}),"login"===JSON.parse(localStorage.getItem("status"))&&(o.addEventListener("click",i),a.addEventListener("click",i));function i(){localStorage.clear(),location.reload()}}),m("1CCW0",function(t,e){var o=_("9eO33"),a=_("fzink"),n=_("fT1hK"),i=_("gdWc9");let s=document.querySelector(".login-modal__close-button"),l=document.querySelector(".phone__open-button"),c=document.querySelector(".header__open-button"),r=document.querySelector(".login-modal__submit-button"),d=document.querySelector(".login-modal-bacdrop"),u=document.querySelector(".login-modal__change-type"),m=document.querySelector("#name"),g=document.querySelector("#email"),h=document.querySelector("#password");if("no login"!==JSON.parse(localStorage.getItem("status")))return;c.addEventListener("click",b),l.addEventListener("click",b),s.addEventListener("click",k),r.addEventListener("click",function(t){if(t.preventDefault(),"singup"===p){let t={name:`${m.value}`,email:`${g.value}`,avatar:"",cards:[],password:`${h.value}`};(0,o.postAccount)(t),localStorage.setItem("account",JSON.stringify(t)),localStorage.setItem("status",JSON.stringify("login")),(0,n.buildHeader)(JSON.parse(localStorage.getItem("account"))),k();return}"singin"===p&&(0,a.getAccount)(m.value,g.value).then(t=>{let e=t[0];h.value===e.password&&(localStorage.setItem("account",JSON.stringify(e)),localStorage.setItem("status",JSON.stringify("login")),(0,n.buildHeader)(JSON.parse(localStorage.getItem("account"))),k())})}),u.addEventListener("click",function(t){let e=t.target,o=document.querySelector(".active-modal");e!==o&&e!==o&&(e.classList.add("active-modal"),o.classList.remove("active-modal"),p=e.id,r.textContent=e.id)});let p="singup";function b(){d.classList.remove("is-hidden")}function k(){d.classList.add("is-hidden")}(0,i.inicalization)()}),m("9eO33",function(t,e){c(t.exports,"postAccount",function(){return o});let o=async t=>{try{let e={method:"POST",body:JSON.stringify(t),headers:{"Content-Type":"application/json; charset=UTF-8"}},o=await fetch("https://67a8ab426e9548e44fc1adc4.mockapi.io/projects/accounts",e).then(t=>o)}catch(t){return t}}}),m("fzink",function(t,e){c(t.exports,"getAccount",function(){return o});let o=async(t,e)=>{try{return await fetch(`https://67a8ab426e9548e44fc1adc4.mockapi.io/projects/accounts?name=${t}&email=${e}`).then(t=>t.json())}catch(t){return t}}}),m("fT1hK",function(t,e){c(t.exports,"buildHeader",function(){return a});let o=document.querySelector(".header");function a(t){o.innerHTML=`<div class="container">
