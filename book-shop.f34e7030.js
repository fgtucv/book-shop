!function(){let e=async()=>{try{return await fetch("https://books-backend.p.goit.global/books/category-list").then(e=>e.json())}catch(e){return e}},t=document.querySelector(".category__list"),a=document.querySelector(".magazine");function o(e,t=!1){let s="";!1===t?s=e.map(e=>`
        ...
        </li>`).join("")),a.innerHTML=s}let s=async e=>{try{return await fetch(`${e}`).then(e=>e.json())}catch(e){return e}},l=document.querySelector(".header__menu-button"),i=document.querySelector(".phone__close-button"),n=document.querySelector(".phone-bacdrop");function c(){n.classList.add("is-hidden"),l.style.display="block",i.style.display="none"}l.addEventListener("click",function(){n.classList.remove("is-hidden"),l.style.display="none",i.style.display="block"}),i.addEventListener("click",c);let r=document.querySelector(".header");function d(e){r.innerHTML=`<div class="container">
