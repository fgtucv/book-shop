let t,e,a,o,n,i,s,l;function c(t,e,a,o){Object.defineProperty(t,e,{get:a,set:o,enumerable:!0,configurable:!0})}var r="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},d={},u={},g=r.parcelRequireb734;null==g&&((g=function(t){if(t in d)return d[t].exports;if(t in u){var e=u[t];delete u[t];var a={id:t,exports:{}};return d[t]=a,e.call(a.exports,a,a.exports),a.exports}var o=Error("Cannot find module '"+t+"'");throw o.code="MODULE_NOT_FOUND",o}).register=function(t,e){u[t]=e},r.parcelRequireb734=g);var h=g.register;h("gdWc9",function(t,e){let a,o;c(t.exports,"inicalization",function(){return l}),c(t.exports,"closeModal",function(){return d});let n=document.querySelector(".phone-bacdrop"),i=document.querySelector(".phoneLogin-bacdrop"),s=document.querySelector(".phoneLogin__account-name");document.querySelector(".header");let l=function(){a=document.querySelector(".header__menu-button"),o=document.querySelector(".phone__close-button"),a.addEventListener("click",r),o.addEventListener("click",d)};function r(){"no login"===JSON.parse(localStorage.getItem("status"))?n.classList.remove("is-hidden"):"login"===JSON.parse(localStorage.getItem("status"))&&(i.classList.remove("is-hidden"),s.textContent=JSON.parse(localStorage.getItem("account")).name),a.style.display="none",o.style.display="flex"}function d(){"no login"===JSON.parse(localStorage.getItem("status"))?n.classList.add("is-hidden"):"login"===JSON.parse(localStorage.getItem("status"))&&i.classList.add("is-hidden"),a.style.display="flex",o.style.display="none"}}),h("fXlgs",function(t,e){let a=document.querySelectorAll(".support__item"),o=document.querySelector(".support__scroll-button");o.addEventListener("click",function(){let t=0;a.forEach(e=>{t<=2?e.classList.toggle("no-showe"):t>5&&e.classList.toggle("no-showe"),t+=1}),a[0].classList.contains("no-showe")?o.style.transform="translate(-50%, 0%) rotate(0deg)":o.style.transform="translate(-50%, 0%) rotate(180deg)"})}),h("1CCW0",function(t,e){var a=g("9eO33"),o=g("fzink"),n=g("fT1hK");let i=document.querySelector(".login-modal__close-button"),s=document.querySelector(".phone__open-button"),l=document.querySelector(".header__open-button"),c=document.querySelector(".login-modal__submit-button"),r=document.querySelector(".login-modal-bacdrop"),d=document.querySelector(".login-modal__change-type"),u=document.querySelector("#name"),h=document.querySelector("#email"),m=document.querySelector("#password");if("no login"!==JSON.parse(localStorage.getItem("status")))return;l.addEventListener("click",_),s.addEventListener("click",_),i.addEventListener("click",b),c.addEventListener("click",function(t){if(t.preventDefault(),"sing up"===p){let t={name:`${u.value}`,email:`${h.value}`,avatar:"",cards:[],password:`${m.value}`};(0,a.postAccount)(t),localStorage.setItem("account",JSON.stringify(t)),localStorage.setItem("status",JSON.stringify("login")),(0,n.buildHeader)(JSON.parse(localStorage.getItem("account"))),b();return}"sing in"===p&&(0,o.getAccount)(u.value,h.value).then(t=>{let e=t[0];m.value===e.password&&(localStorage.setItem("account",JSON.stringify(e)),localStorage.setItem("status",JSON.stringify("login")),(0,n.buildHeader)(JSON.parse(localStorage.getItem("account"))),b())})}),d.addEventListener("click",function(t){let e=t.target,a=document.querySelector(".active-modal");e!==a&&e!==a&&(e.classList.add("active-modal"),a.classList.remove("active-modal"),p=e.id,c.textContent=e.id)});let p="sing up";function _(){r.classList.remove("is-hidden")}function b(){r.classList.add("is-hidden")}}),h("9eO33",function(t,e){c(t.exports,"postAccount",function(){return a});let a=async t=>{try{let e={method:"POST",body:JSON.stringify(t),headers:{"Content-Type":"application/json; charset=UTF-8"}},a=await fetch("https://67a8ab426e9548e44fc1adc4.mockapi.io/projects/accounts",e).then(t=>a)}catch(t){return t}}}),h("fzink",function(t,e){c(t.exports,"getAccount",function(){return a});let a=async(t,e)=>{try{return await fetch(`https://67a8ab426e9548e44fc1adc4.mockapi.io/projects/accounts?name=${t}&email=${e}`).then(t=>t.json())}catch(t){return t}}}),h("fT1hK",function(t,e){c(t.exports,"buildHeader",function(){return o});let a=document.querySelector(".header");function o(t){a.innerHTML=`<div class="container">
        ...
        </div>`}}),h("3QkRd",function(t,e){let a=document.querySelector(".header__exit-button"),o=document.querySelector(".phoneLogin__exit-button"),n=document.querySelector(".header__account-button");if("login"===JSON.parse(localStorage.getItem("status")))n.addEventListener("click",function(){a.classList.contains("is-hidden")?a.classList.remove("is-hidden"):a.classList.contains("is-hidden")||a.classList.add("is-hidden")}),"login"===JSON.parse(localStorage.getItem("status"))&&(a.addEventListener("click",i),o.addEventListener("click",i));function i(){localStorage.clear(),location.reload()}}),h("da45K",function(t,e){console.log(1)});const m=async()=>{try{return await fetch("https://books-backend.p.goit.global/books/category-list").then(t=>t.json())}catch(t){return t}},p=document.querySelector(".category__list"),_=document.querySelector(".magazine");function b(t,e=!1){let a="";!1===e?a=t.map(t=>`
        ...
        </li>`).join("")),_.innerHTML=a}const k=async t=>{try{return await fetch(`${t}`).then(t=>t.json())}catch(t){return t}};var y=g("gdWc9"),f=g("fT1hK");const C=document.querySelector(".phone__open-button");"login"===JSON.parse(localStorage.getItem("status"))?(0,f.buildHeader)(JSON.parse(localStorage.getItem("account"))):localStorage.setItem("status",JSON.stringify("no login")),m().then(t=>{let e;e="",e=t.map(t=>`
        <li class="category__item">
            <span class="category__span">${t.list_name}</span>
        </li>`).join(""),p.insertAdjacentHTML("beforeend",e)}),k("https://books-backend.p.goit.global/books/top-books").then(t=>{b(t,!0)}),C.addEventListener("click",()=>{(0,y.closeModal)()});const v=document.querySelector(".category__list"),S=document.querySelector(".shop_title");document.querySelector(".magazine__book-list"),v.addEventListener("click",function(t){let e=t.target;if(!e.classList.contains("active")){if(!1!==e.parentNode.classList.contains("category__item"))if("All categories"===e.textContent)document.querySelector(".active").classList.remove("active"),e.classList.add("active"),S.innerHTML="Best Sellers <span class='shop_title-purpure'>magazine</span>",k("https://books-backend.p.goit.global/books/top-books").then(t=>{b(t,!0)});else{document.querySelector(".active").classList.remove("active"),e.classList.add("active");let t=e.textContent.split(" ");S.innerHTML=`${t.slice(0,-1).join(" ")} <span class="shop_title-purpure">${t.at(-1)}</span>`,k(`https://books-backend.p.goit.global/books/category?category=${e.textContent}`).then(t=>{b(t)})}}}),g("fXlgs"),g("1CCW0"),g("gdWc9"),g("fT1hK"),g("fzink"),g("9eO33"),g("3QkRd");const $=document.querySelector(".magazine"),L=document.querySelector(".shop_title");$.addEventListener("click",function(t){let e=t.target;if(e.classList.contains("magazine__button")){k(`https://books-backend.p.goit.global/books/category?category=${e.getAttribute("data-type")}`).then(t=>{b(t)});let t=e.getAttribute("data-type").split(" ");L.innerHTML=`${t.slice(0,-1).join(" ")} <span class="shop_title-purpure">${t.at(-1)}</span>`}});const w=async function(t,e){try{let a={method:"PUT",body:JSON.stringify(t),headers:{"Content-Type":"application/json; charset=UTF-8"}};return await fetch(`https://67a8ab426e9548e44fc1adc4.mockapi.io/projects/accounts/${e}`,a).then(t=>t.json())}catch(t){return t}},H=document.querySelector(".magazine"),M=document.querySelector(".addModal-backdrop"),z=document.querySelector(".addModal__close-button"),q=document.querySelector(".addModal__button"),x=document.querySelector(".addModal__img"),V=document.querySelector(".addModal__title"),O=document.querySelector(".addModal__text"),E=document.querySelector(".addModal__name");H.addEventListener("click",function(c){let r=c.target.parentNode;r.classList.contains("magazine__item")&&(x.src=r.getAttribute("data-img"),V.textContent=r.getAttribute("data-title"),O.textContent=r.getAttribute("data-description"),E.textContent=r.getAttribute("data-author"),t=r.getAttribute("data-img"),e=r.getAttribute("data-title"),a=r.getAttribute("data-description"),o=r.getAttribute("data-author"),n=r.id,l=r.getAttribute("data-type"),i=r.getAttribute("data-amazon"),s=r.getAttribute("data-aplle"),M.classList.remove("is-hidden"))}),z.addEventListener("click",function(){M.classList.add("is-hidden")}),q.addEventListener("click",function(){let c={id:n,imgUrl:t,title:e,text:a,type:l,authorName:o,amazonBuyLink:i,aplleBookBuyLink:s},r=JSON.parse(localStorage.getItem("account"));r.cards.push(c),localStorage.setItem("account",JSON.stringify(r)),w(JSON.parse(localStorage.getItem("account")),JSON.parse(localStorage.getItem("account")).id),M.classList.add("is-hidden")}),g("da45K");
//# sourceMappingURL=book-shop.fdffb763.js.map
