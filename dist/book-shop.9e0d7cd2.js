let t,e,a,o,i,n,s,l;function c(t,e,a,o){Object.defineProperty(t,e,{get:a,set:o,enumerable:!0,configurable:!0})}var r="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},d={},u={},h=r.parcelRequireb734;null==h&&((h=function(t){if(t in d)return d[t].exports;if(t in u){var e=u[t];delete u[t];var a={id:t,exports:{}};return d[t]=a,e.call(a.exports,a,a.exports),a.exports}var o=Error("Cannot find module '"+t+"'");throw o.code="MODULE_NOT_FOUND",o}).register=function(t,e){u[t]=e},r.parcelRequireb734=h);var g=h.register;g("1CCW0",function(t,e){var a=h("9eO33"),o=h("fzink"),i=h("fT1hK");let n=document.querySelector(".login-modal__close-button"),s=document.querySelector(".phone__open-button"),l=document.querySelector(".header__open-button"),c=document.querySelector(".login-modal__submit-button"),r=document.querySelector(".login-modal-bacdrop"),d=document.querySelector(".login-modal__change-type"),u=document.querySelector("#name"),g=document.querySelector("#email"),m=document.querySelector("#password");if("no login"!==JSON.parse(localStorage.getItem("status")))return;l.addEventListener("click",b),s.addEventListener("click",b),n.addEventListener("click",p),c.addEventListener("click",function(t){if(t.preventDefault(),"sing up"===_){let t={name:`${u.value}`,email:`${g.value}`,avatar:"",cards:[],password:`${m.value}`};(0,a.postAccount)(t),localStorage.setItem("account",JSON.stringify(t)),localStorage.setItem("status",JSON.stringify("login")),(0,i.buildHeader)(JSON.parse(localStorage.getItem("account"))),p();return}"sing in"===_&&(0,o.getAccount)(u.value,g.value).then(t=>{let e=t[0];m.value===e.password&&(localStorage.setItem("account",JSON.stringify(e)),localStorage.setItem("status",JSON.stringify("login")),(0,i.buildHeader)(JSON.parse(localStorage.getItem("account"))),p())})}),d.addEventListener("click",function(t){let e=t.target,a=document.querySelector(".active-modal");e!==a&&e!==a&&(e.classList.add("active-modal"),a.classList.remove("active-modal"),_=e.id,c.textContent=e.id)});let _="sing up";function b(){r.classList.remove("is-hidden")}function p(){r.classList.add("is-hidden")}}),g("9eO33",function(t,e){c(t.exports,"postAccount",function(){return a});let a=async t=>{try{let e={method:"POST",body:JSON.stringify(t),headers:{"Content-Type":"application/json; charset=UTF-8"}},a=await fetch("https://67a8ab426e9548e44fc1adc4.mockapi.io/projects/accounts",e).then(t=>a)}catch(t){return t}}}),g("fzink",function(t,e){c(t.exports,"getAccount",function(){return a});let a=async(t,e)=>{try{return await fetch(`https://67a8ab426e9548e44fc1adc4.mockapi.io/projects/accounts?name=${t}&email=${e}`).then(t=>t.json())}catch(t){return t}}}),g("fT1hK",function(t,e){c(t.exports,"buildHeader",function(){return o});let a=document.querySelector(".header");function o(t){a.innerHTML=`<div class="container">
        ...
        </li>`).join("")),b.innerHTML=a}const k=async t=>{try{return await fetch(`${t}`).then(t=>t.json())}catch(t){return t}},y=document.querySelector(".header__menu-button"),f=document.querySelector(".phone__close-button"),C=document.querySelector(".phone-bacdrop");function v(){C.classList.add("is-hidden"),y.style.display="block",f.style.display="none"}y.addEventListener("click",function(){C.classList.remove("is-hidden"),y.style.display="none",f.style.display="block"}),f.addEventListener("click",v);var $=h("fT1hK");const S=document.querySelector(".phone__open-button");"login"===JSON.parse(localStorage.getItem("status"))?(0,$.buildHeader)(JSON.parse(localStorage.getItem("account"))):localStorage.setItem("status",JSON.stringify("no login")),m().then(t=>{let e;e="",e=t.map(t=>`
        <li class="category__item">
            <span class="category__span">${t.list_name}</span>
        </li>`).join(""),_.insertAdjacentHTML("beforeend",e)}),k("https://books-backend.p.goit.global/books/top-books").then(t=>{p(t,!0)}),S.addEventListener("click",()=>{v()});const L=document.querySelector(".category__list"),w=document.querySelector(".shop_title");document.querySelector(".magazine__book-list"),L.addEventListener("click",function(t){let e=t.target;if(!e.classList.contains("active")){if(!1!==e.parentNode.classList.contains("category__item"))if("All categories"===e.textContent)document.querySelector(".active").classList.remove("active"),e.classList.add("active"),w.innerHTML="Best Sellers <span class='shop_title-purpure'>magazine</span>",k("https://books-backend.p.goit.global/books/top-books").then(t=>{p(t,!0)});else{document.querySelector(".active").classList.remove("active"),e.classList.add("active");let t=e.textContent.split(" ");w.innerHTML=`${t.slice(0,-1).join(" ")} <span class="shop_title-purpure">${t.at(-1)}</span>`,k(`https://books-backend.p.goit.global/books/category?category=${e.textContent}`).then(t=>{p(t)})}}});const H=document.querySelectorAll(".support__item"),M=document.querySelector(".support__scroll-button");M.addEventListener("click",function(){let t=0;H.forEach(e=>{t<=2?e.classList.toggle("no-showe"):t>5&&e.classList.toggle("no-showe"),t+=1}),H[0].classList.contains("no-showe")?M.style.transform="translate(-50%, 0%) rotate(0deg)":M.style.transform="translate(-50%, 0%) rotate(180deg)"}),h("1CCW0"),h("fT1hK"),h("fzink"),h("9eO33"),h("3QkRd");const z=document.querySelector(".magazine"),q=document.querySelector(".shop_title");z.addEventListener("click",function(t){let e=t.target;if(e.classList.contains("magazine__button")){k(`https://books-backend.p.goit.global/books/category?category=${e.getAttribute("data-type")}`).then(t=>{p(t)});let t=e.getAttribute("data-type").split(" ");q.innerHTML=`${t.slice(0,-1).join(" ")} <span class="shop_title-purpure">${t.at(-1)}</span>`}});const V=async function(t,e){try{let a={method:"PUT",body:JSON.stringify(t),headers:{"Content-Type":"application/json; charset=UTF-8"}};return await fetch(`https://67a8ab426e9548e44fc1adc4.mockapi.io/projects/accounts/${e}`,a).then(t=>t.json())}catch(t){return t}},x=document.querySelector(".magazine"),E=document.querySelector(".addModal-backdrop"),O=document.querySelector(".addModal__close-button"),Z=document.querySelector(".addModal__button"),j=document.querySelector(".addModal__img"),N=document.querySelector(".addModal__title"),A=document.querySelector(".addModal__text"),T=document.querySelector(".addModal__name");x.addEventListener("click",function(c){let r=c.target.parentNode;r.classList.contains("magazine__item")&&(j.src=r.getAttribute("data-img"),N.textContent=r.getAttribute("data-title"),A.textContent=r.getAttribute("data-description"),T.textContent=r.getAttribute("data-author"),t=r.getAttribute("data-img"),e=r.getAttribute("data-title"),a=r.getAttribute("data-description"),o=r.getAttribute("data-author"),i=r.id,l=r.getAttribute("data-type"),n=r.getAttribute("data-amazon"),s=r.getAttribute("data-aplle"),E.classList.remove("is-hidden"))}),O.addEventListener("click",function(){E.classList.add("is-hidden")}),Z.addEventListener("click",function(){let c={id:i,imgUrl:t,title:e,text:a,type:l,authorName:o,amazonBuyLink:n,aplleBookBuyLink:s},r=JSON.parse(localStorage.getItem("account"));r.cards.push(c),localStorage.setItem("account",JSON.stringify(r)),V(JSON.parse(localStorage.getItem("account")),JSON.parse(localStorage.getItem("account")).id),E.classList.add("is-hidden")});
//# sourceMappingURL=book-shop.9e0d7cd2.js.map
