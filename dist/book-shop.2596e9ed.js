let t,e,a,o,i,n,s,l;function c(t,e,a,o){Object.defineProperty(t,e,{get:a,set:o,enumerable:!0,configurable:!0})}var r="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},d={},u={},g=r.parcelRequireb734;null==g&&((g=function(t){if(t in d)return d[t].exports;if(t in u){var e=u[t];delete u[t];var a={id:t,exports:{}};return d[t]=a,e.call(a.exports,a,a.exports),a.exports}var o=Error("Cannot find module '"+t+"'");throw o.code="MODULE_NOT_FOUND",o}).register=function(t,e){u[t]=e},r.parcelRequireb734=g);var h=g.register;h("gdWc9",function(t,e){let a,o;c(t.exports,"inicalization",function(){return l}),c(t.exports,"closeModal",function(){return d});let i=document.querySelector(".phone-bacdrop"),n=document.querySelector(".phoneLogin-bacdrop"),s=document.querySelector(".phoneLogin__account-name"),l=function(){a=document.querySelector(".header__menu-button"),o=document.querySelector(".phone__close-button"),(null!==a||null!==o)&&(a.addEventListener("click",r),o.addEventListener("click",d))};function r(){"no login"===JSON.parse(localStorage.getItem("status"))?i.classList.remove("is-hidden"):"login"===JSON.parse(localStorage.getItem("status"))&&(n.classList.remove("is-hidden"),s.textContent=JSON.parse(localStorage.getItem("account")).name),a.style.display="none",o.style.display="flex"}function d(){"no login"===JSON.parse(localStorage.getItem("status"))?i.classList.add("is-hidden"):"login"===JSON.parse(localStorage.getItem("status"))&&n.classList.add("is-hidden"),a.style.display="flex",o.style.display="none"}}),h("fXlgs",function(t,e){let a=document.querySelectorAll(".support__item"),o=document.querySelector(".support__scroll-button");o.addEventListener("click",function(){let t=0;a.forEach(e=>{t<=2?e.classList.toggle("no-showe"):t>5&&e.classList.toggle("no-showe"),t+=1}),a[0].classList.contains("no-showe")?o.style.transform="translate(-50%, 0%) rotate(0deg)":o.style.transform="translate(-50%, 0%) rotate(180deg)"})}),h("1CCW0",function(t,e){var a=g("9eO33"),o=g("fzink"),i=g("fT1hK"),n=g("gdWc9");let s=document.querySelector(".login-modal__close-button"),l=document.querySelector(".phone__open-button"),c=document.querySelector(".header__open-button"),r=document.querySelector(".login-modal__submit-button"),d=document.querySelector(".login-modal-bacdrop"),u=document.querySelector(".login-modal__change-type"),h=document.querySelector("#name"),m=document.querySelector("#email"),p=document.querySelector("#password");if("no login"!==JSON.parse(localStorage.getItem("status")))return;c.addEventListener("click",b),l.addEventListener("click",b),s.addEventListener("click",k),r.addEventListener("click",function(t){if(t.preventDefault(),"sing up"===_){let t={name:`${h.value}`,email:`${m.value}`,avatar:"",cards:[],password:`${p.value}`};(0,a.postAccount)(t),localStorage.setItem("account",JSON.stringify(t)),localStorage.setItem("status",JSON.stringify("login")),(0,i.buildHeader)(JSON.parse(localStorage.getItem("account"))),k();return}"sing in"===_&&(0,o.getAccount)(h.value,m.value).then(t=>{let e=t[0];p.value===e.password&&(localStorage.setItem("account",JSON.stringify(e)),localStorage.setItem("status",JSON.stringify("login")),(0,i.buildHeader)(JSON.parse(localStorage.getItem("account"))),k())})}),u.addEventListener("click",function(t){let e=t.target,a=document.querySelector(".active-modal");e!==a&&e!==a&&(e.classList.add("active-modal"),a.classList.remove("active-modal"),_=e.id,r.textContent=e.id)});let _="sing up";function b(){d.classList.remove("is-hidden")}function k(){d.classList.add("is-hidden")}(0,n.inicalization)()}),h("9eO33",function(t,e){c(t.exports,"postAccount",function(){return a});let a=async t=>{try{let e={method:"POST",body:JSON.stringify(t),headers:{"Content-Type":"application/json; charset=UTF-8"}},a=await fetch("https://67a8ab426e9548e44fc1adc4.mockapi.io/projects/accounts",e).then(t=>a)}catch(t){return t}}}),h("fzink",function(t,e){c(t.exports,"getAccount",function(){return a});let a=async(t,e)=>{try{return await fetch(`https://67a8ab426e9548e44fc1adc4.mockapi.io/projects/accounts?name=${t}&email=${e}`).then(t=>t.json())}catch(t){return t}}}),h("fT1hK",function(t,e){c(t.exports,"buildHeader",function(){return o});let a=document.querySelector(".header");function o(t){a.innerHTML=`<div class="container">
        ...
        </div>`}}),h("3QkRd",function(t,e){let a=document.querySelector(".header__exit-button"),o=document.querySelector(".phoneLogin__exit-button"),i=document.querySelector(".header__account-button");if("login"===JSON.parse(localStorage.getItem("status")))i.addEventListener("click",function(){a.classList.contains("is-hidden")?a.classList.remove("is-hidden"):a.classList.contains("is-hidden")||a.classList.add("is-hidden")}),"login"===JSON.parse(localStorage.getItem("status"))&&(a.addEventListener("click",n),o.addEventListener("click",n));function n(){localStorage.clear(),location.reload()}});const m=async()=>{try{return await fetch("https://books-backend.p.goit.global/books/category-list").then(t=>t.json())}catch(t){return t}},p=document.querySelector(".category__list"),_=document.querySelector(".magazine");function b(t,e=!1){let a="";!1===e?a=t.map(t=>`
