let t,e,a,o,i,n,s,l;function c(t,e,a,o){Object.defineProperty(t,e,{get:a,set:o,enumerable:!0,configurable:!0})}var r="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},d={},u={},h=r.parcelRequireb734;null==h&&((h=function(t){if(t in d)return d[t].exports;if(t in u){var e=u[t];delete u[t];var a={id:t,exports:{}};return d[t]=a,e.call(a.exports,a,a.exports),a.exports}var o=Error("Cannot find module '"+t+"'");throw o.code="MODULE_NOT_FOUND",o}).register=function(t,e){u[t]=e},r.parcelRequireb734=h);var g=h.register;g("gdWc9",function(t,e){c(t.exports,"closeModal",function(){return n});let a=document.querySelector(".header__menu-button"),o=document.querySelector(".phone__close-button"),i=document.querySelector(".phone-bacdrop");function n(){i.classList.add("is-hidden"),a.style.display="block",o.style.display="none"}"login"===JSON.parse(localStorage.getItem("status"))&&(a.addEventListener("click",function(){i.classList.remove("is-hidden"),a.style.display="none",o.style.display="block"}),o.addEventListener("click",n))}),g("1CCW0",function(t,e){var a=h("9eO33"),o=h("fzink"),i=h("fT1hK");let n=document.querySelector(".login-modal__close-button"),s=document.querySelector(".phone__open-button"),l=document.querySelector(".header__open-button"),c=document.querySelector(".login-modal__submit-button"),r=document.querySelector(".login-modal-bacdrop"),d=document.querySelector(".login-modal__change-type"),u=document.querySelector("#name"),g=document.querySelector("#email"),m=document.querySelector("#password");if("no login"!==JSON.parse(localStorage.getItem("status")))return;l.addEventListener("click",p),s.addEventListener("click",p),n.addEventListener("click",b),c.addEventListener("click",function(t){if(t.preventDefault(),"sing up"===_){let t={name:`${u.value}`,email:`${g.value}`,avatar:"",cards:[],password:`${m.value}`};(0,a.postAccount)(t),localStorage.setItem("account",JSON.stringify(t)),localStorage.setItem("status",JSON.stringify("login")),(0,i.buildHeader)(JSON.parse(localStorage.getItem("account"))),b();return}"sing in"===_&&(0,o.getAccount)(u.value,g.value).then(t=>{let e=t[0];m.value===e.password&&(localStorage.setItem("account",JSON.stringify(e)),localStorage.setItem("status",JSON.stringify("login")),(0,i.buildHeader)(JSON.parse(localStorage.getItem("account"))),b())})}),d.addEventListener("click",function(t){let e=t.target,a=document.querySelector(".active-modal");e!==a&&e!==a&&(e.classList.add("active-modal"),a.classList.remove("active-modal"),_=e.id,c.textContent=e.id)});let _="sing up";function p(){r.classList.remove("is-hidden")}function b(){r.classList.add("is-hidden")}}),g("9eO33",function(t,e){c(t.exports,"postAccount",function(){return a});let a=async t=>{try{let e={method:"POST",body:JSON.stringify(t),headers:{"Content-Type":"application/json; charset=UTF-8"}},a=await fetch("https://67a8ab426e9548e44fc1adc4.mockapi.io/projects/accounts",e).then(t=>a)}catch(t){return t}}}),g("fzink",function(t,e){c(t.exports,"getAccount",function(){return a});let a=async(t,e)=>{try{return await fetch(`https://67a8ab426e9548e44fc1adc4.mockapi.io/projects/accounts?name=${t}&email=${e}`).then(t=>t.json())}catch(t){return t}}}),g("fT1hK",function(t,e){c(t.exports,"buildHeader",function(){return o});let a=document.querySelector(".header");function o(t){a.innerHTML=`<div class="container">
        ...
        </div>`}}),g("3QkRd",function(t,e){let a=document.querySelector(".header__exit-button");document.querySelector(".header__account-button").addEventListener("click",function(){a.classList.contains("is-hidden")?(a.classList.remove("is-hidden"),console.log("1")):a.classList.contains("is-hidden")||a.classList.add("is-hidden")}),"login"===JSON.parse(localStorage.getItem("status"))&&a.addEventListener("click",function(){localStorage.clear(),location.reload()})});const m=async()=>{try{return await fetch("https://books-backend.p.goit.global/books/category-list").then(t=>t.json())}catch(t){return t}},_=document.querySelector(".category__list"),p=document.querySelector(".magazine");function b(t,e=!1){let a="";!1===e?a=t.map(t=>`
        ...
        </li>`).join("")),p.innerHTML=a}const k=async t=>{try{return await fetch(`${t}`).then(t=>t.json())}catch(t){return t}};var y=h("gdWc9"),f=h("fT1hK");const C=document.querySelector(".phone__open-button");"login"===JSON.parse(localStorage.getItem("status"))?(0,f.buildHeader)(JSON.parse(localStorage.getItem("account"))):localStorage.setItem("status",JSON.stringify("no login")),m().then(t=>{let e;e="",e=t.map(t=>`
        <li class="category__item">
            <span class="category__span">${t.list_name}</span>
        </li>`).join(""),_.insertAdjacentHTML("beforeend",e)}),k("https://books-backend.p.goit.global/books/top-books").then(t=>{b(t,!0)}),C.addEventListener("click",()=>{(0,y.closeModal)()});const v=document.querySelector(".category__list"),$=document.querySelector(".shop_title");document.querySelector(".magazine__book-list"),v.addEventListener("click",function(t){let e=t.target;if(!e.classList.contains("active")){if(!1!==e.parentNode.classList.contains("category__item"))if("All categories"===e.textContent)document.querySelector(".active").classList.remove("active"),e.classList.add("active"),$.innerHTML="Best Sellers <span class='shop_title-purpure'>magazine</span>",k("https://books-backend.p.goit.global/books/top-books").then(t=>{b(t,!0)});else{document.querySelector(".active").classList.remove("active"),e.classList.add("active");let t=e.textContent.split(" ");$.innerHTML=`${t.slice(0,-1).join(" ")} <span class="shop_title-purpure">${t.at(-1)}</span>`,k(`https://books-backend.p.goit.global/books/category?category=${e.textContent}`).then(t=>{b(t)})}}});const S=document.querySelectorAll(".support__item"),L=document.querySelector(".support__scroll-button");L.addEventListener("click",function(){let t=0;S.forEach(e=>{t<=2?e.classList.toggle("no-showe"):t>5&&e.classList.toggle("no-showe"),t+=1}),S[0].classList.contains("no-showe")?L.style.transform="translate(-50%, 0%) rotate(0deg)":L.style.transform="translate(-50%, 0%) rotate(180deg)"}),h("1CCW0"),h("gdWc9"),h("fT1hK"),h("fzink"),h("9eO33"),h("3QkRd");const w=document.querySelector(".magazine"),H=document.querySelector(".shop_title");w.addEventListener("click",function(t){let e=t.target;if(e.classList.contains("magazine__button")){k(`https://books-backend.p.goit.global/books/category?category=${e.getAttribute("data-type")}`).then(t=>{b(t)});let t=e.getAttribute("data-type").split(" ");H.innerHTML=`${t.slice(0,-1).join(" ")} <span class="shop_title-purpure">${t.at(-1)}</span>`}});const M=async function(t,e){try{let a={method:"PUT",body:JSON.stringify(t),headers:{"Content-Type":"application/json; charset=UTF-8"}};return await fetch(`https://67a8ab426e9548e44fc1adc4.mockapi.io/projects/accounts/${e}`,a).then(t=>t.json())}catch(t){return t}},z=document.querySelector(".magazine"),q=document.querySelector(".addModal-backdrop"),V=document.querySelector(".addModal__close-button"),x=document.querySelector(".addModal__button"),E=document.querySelector(".addModal__img"),O=document.querySelector(".addModal__title"),Z=document.querySelector(".addModal__text"),N=document.querySelector(".addModal__name");z.addEventListener("click",function(c){let r=c.target.parentNode;r.classList.contains("magazine__item")&&(E.src=r.getAttribute("data-img"),O.textContent=r.getAttribute("data-title"),Z.textContent=r.getAttribute("data-description"),N.textContent=r.getAttribute("data-author"),t=r.getAttribute("data-img"),e=r.getAttribute("data-title"),a=r.getAttribute("data-description"),o=r.getAttribute("data-author"),i=r.id,l=r.getAttribute("data-type"),n=r.getAttribute("data-amazon"),s=r.getAttribute("data-aplle"),q.classList.remove("is-hidden"))}),V.addEventListener("click",function(){q.classList.add("is-hidden")}),x.addEventListener("click",function(){let c={id:i,imgUrl:t,title:e,text:a,type:l,authorName:o,amazonBuyLink:n,aplleBookBuyLink:s},r=JSON.parse(localStorage.getItem("account"));r.cards.push(c),localStorage.setItem("account",JSON.stringify(r)),M(JSON.parse(localStorage.getItem("account")),JSON.parse(localStorage.getItem("account")).id),q.classList.add("is-hidden")});
//# sourceMappingURL=book-shop.43cc76f6.js.map
